...
/** Call all functions to get data from backend and display it on dashboard*/
...
function displaySavedWorkoutPlans() {
    ...
    //Create workout plan cards on dashboard
...
function displaySavedWorkoutVideos() {
    ...
    //Creates video containers to display on dashboard
...
function createVideoContainer(savedWorkoutVideo) {
    ...
    //Shorten video title to display on dashboard
