...
public class WorkoutProfileUtils {
  ...
  /**
   * Stores all generated workout plans in Datastore if user is logged in
   *
  ...
  /**
   * Retrieves stored WorkoutPlan from Datastore that user wants to save
   *
  ...
  /**
   * Saves WorkoutPlan in Datastore when requested by user (on button click)
   *
  ...
  /**
   * Retrieves saved WorkoutPlans from Datastore to display on user's workout dashboard
   *
   * @param userID The current logged-in user's ID number
  ...
  /**
   * Returns next workoutPlanId when storing WorkoutPlan (determined by number of workout plans
  ...
  /**
   * Stores all generated workout videos in Datastore if user is logged in
   *
  ...
  /**
   * Retrieves stored workout video (YouTubeVideo) from Datastore that user wants to save
   *
   * @param userID The current logged-in user's ID number
  ...
  /**
   * Saves YouTubeVideo workout video in Datastore when requested by user (on button click)
   *
  ...
  /**
   * Retrieves saved workout videos (YouTubeVideo) from Datastore to display on user's workout
   * dashboard
   *
   * @param userID The current logged-in user's ID number
   * @param datastore Datastore instance to retrieve WorkoutPlans from database
